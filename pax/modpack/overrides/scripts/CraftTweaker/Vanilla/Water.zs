...
static allWater as IIngredient = <minecraft:water_bucket>
    ...
    | <pyrotech:bucket_refractory>   .withTag({fluids: {FluidName: "purifiedwater", Amount: 1000}})
    ...
    | <pyrotech:bucket_refractory>   .withTag({fluids: {FluidName: "saltwater", Amount: 1000}})
