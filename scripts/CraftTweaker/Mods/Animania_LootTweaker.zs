...
for i, loc in largeAnimals {
    ...
    val mainPool = i.addPool("main3", 1, 1, 0, 0);
    val mainPool2 = i.addPool("main2", 1, 1, 0, 0);

    // Drop 4-8 Leather
    mainPool.addItemEntry(<minecraft:leather>, 1, 0);
    // Drop 10-20 bones
    mainPool2.addItemEntry(<minecraft:bone>, 1, 0);
}
