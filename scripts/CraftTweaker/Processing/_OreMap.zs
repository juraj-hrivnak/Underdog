...
// Modded
    <ore:oreCopper> : [
        <divergentunderground:ie_hard_copper_ore>       ,
        <immersiveengineering:ore>                      ,
        <divergentunderground:mekanism_hard_copper_ore> ,
        <mekanism:oreblock:1>                           ,
        <forestry:resources:1>                          ,
        <divergentunderground:forestry_hard_copper_ore>
    ],
    <ore:oreTin> : [
        <divergentunderground:mekanism_hard_tin_ore>    ,
        <mekanism:oreblock:2>                           ,
        <forestry:resources:2>                          ,
        <divergentunderground:forestry_hard_tin_ore>
    ],
