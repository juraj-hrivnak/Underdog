...
val listOfWoods as IItemStack[][][IOreDictEntry[]] = {
    ...
    [<ore:softwoodLumber>, <ore:softwoodLog>, <ore:softwoodPlanks>] : [
        // Vanilla
    ...
    [<ore:hardwoodLumber>, <ore:hardwoodLog>, <ore:hardwoodPlanks>] : [
        // Vanilla
...
furnace.setFuel(<ore:softwoodLumber>, 160);
furnace.setFuel(<ore:softwoodLog>   , 600);
furnace.setFuel(<ore:softwoodPlanks>, 300);

furnace.setFuel(<ore:hardwoodLumber>, 240);
furnace.setFuel(<ore:hardwoodLog>   , 900);
furnace.setFuel(<ore:hardwoodPlanks>, 440);
...
// <ore:heavy>.addAll(<ore:hardwoodLog>);
