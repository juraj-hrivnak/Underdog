...
// Logistics Crafting Table (class net.minecraft.item.crafting.ShapedRecipes)
...
// Logistics Block Frame (class net.minecraft.item.crafting.ShapedRecipes)
item('logisticspipes:frame').tweakRecipe(
    [ore('ingotIron'), ore('dustRedstone'), ore('ingotIron')],
    [ore('lumber'), null, ore('lumber')]
)

// Remote Orderer Logistics Pipe (class net.minecraftforge.oredict.ShapedOreRecipe)
...
// Logistics Inventory System Connector (class net.minecraftforge.oredict.ShapedOreRecipe)
...
// Logistics Firewall Pipe (class net.minecraftforge.oredict.ShapedOreRecipe)
