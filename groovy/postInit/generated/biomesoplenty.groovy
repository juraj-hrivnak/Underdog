...
(item('biomesoplenty:mangrove_stairs') * 4).tweakRecipe(
    [item('contenttweaker:lumber_mangrove'), null, null],
    [item('contenttweaker:lumber_mangrove'), item('contenttweaker:lumber_mangrove'), null],
...
// Cherry Wood Stairs
(item('biomesoplenty:cherry_stairs') * 4).tweakRecipe(
    [item('contenttweaker:lumber_cherry'), null, null],
    [item('contenttweaker:lumber_cherry'), item('contenttweaker:lumber_cherry'), null],
...
// Sacred Oak Boat
item('biomesoplenty:boat_sacred_oak').tweakRecipe(
    [item('contenttweaker:lumber_sacred_oak'), null, item('contenttweaker:lumber_sacred_oak')],
...
// Mahogany Boat
item('biomesoplenty:boat_mahogany').tweakRecipe(
    [item('contenttweaker:lumber_mahogany'), null, item('contenttweaker:lumber_mahogany')],
...
// Eucalyptus Boat
item('biomesoplenty:boat_eucalyptus').tweakRecipe(
    [item('contenttweaker:lumber_eucalyptus'), null, item('contenttweaker:lumber_eucalyptus')],
    [item('contenttweaker:lumber_eucalyptus'), item('contenttweaker:lumber_eucalyptus'), item('contenttweaker:lumber_eucalyptus')]
)

// Ethereal Boat
item('biomesoplenty:boat_ethereal').tweakRecipe(
    [item('contenttweaker:lumber_ethereal'), null, item('contenttweaker:lumber_ethereal')],
