...
// Vector Plate (class net.minecraftforge.oredict.ShapedOreRecipe)
...
// Sneaky Block (class net.minecraftforge.oredict.ShapedOreRecipe)
...
// Sneaky Torch (class net.minecraftforge.oredict.ShapelessOreRecipe)
item('darkutils:sneaky_torch').tweakRecipe(
    item('darkutils:sneaky'), item('burningtorch:burningtorch')
)

// Timer (class net.minecraftforge.oredict.ShapedOreRecipe)
...
// Mob Filter (class net.minecraftforge.oredict.ShapedOreRecipe)
...
// Item Grate (class net.minecraftforge.oredict.ShapelessOreRecipe)
item('darkutils:grate').tweakRecipe(
    ore('stones'), item('minecraft:iron_bars'), item('minecraft:trapdoor')
)

// Portal Charm (class net.minecraftforge.oredict.ShapedOreRecipe)
...
// Anti-Slime Block (class net.minecraftforge.oredict.ShapedOreRecipe)
